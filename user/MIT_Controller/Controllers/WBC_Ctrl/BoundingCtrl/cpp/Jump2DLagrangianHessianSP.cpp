...
// File: Jump2DLagrangianHessianSP.cpp
//
...
// Return Type  : void
//
void Jump2DLagrangianHessianSP(int iter, int NUM_X, int row_index_H[10],
  int col_index_H[10])
{
  int t2;
  ...
  memcpy(&col_index_H[0], &row_index_H[0], 10U * sizeof(int));
}

//
// File trailer for Jump2DLagrangianHessianSP.cpp
//
// [EOF]
//
