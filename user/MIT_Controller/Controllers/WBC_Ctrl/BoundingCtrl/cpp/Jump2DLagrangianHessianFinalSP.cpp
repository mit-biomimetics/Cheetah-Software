...
// File: Jump2DLagrangianHessianFinalSP.cpp
//
...
// Arguments    : int iter
//                int NUM_X
//                int row_index_final_H[10]
//                int col_index_final_H[10]
// Return Type  : void
//
void Jump2DLagrangianHessianFinalSP(int iter, int NUM_X, int
  row_index_final_H[10], int col_index_final_H[10])
{
  int t2;
  ...
  memcpy(&col_index_final_H[0], &row_index_final_H[0], 10U * sizeof(int));
}

//
// File trailer for Jump2DLagrangianHessianFinalSP.cpp
//
// [EOF]
//
